<?php
    ...
    * File: /views/home/editview.php
    * Purpose: Edit View Class.  Handles Display Logic for home/edit route.
    */
    ...
    * @Inject acl
    */
    class EditView extends \PiwikManager\Views\View
    {
        ...
        public function output ()
        {
            ...
            if ($sherpa_id) {
                ...
                if ($result && isset($result[$sherpa_id])) {
                    ...
                    $this->template->assignMeta("Edit Account Settings.", 
                        "description");
